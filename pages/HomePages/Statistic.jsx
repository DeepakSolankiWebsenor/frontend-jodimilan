            ...
            <section className="text-gray-600 body-font">
                <div className="container lg:px-24 mx-px-14 px-4 py-10 mx-auto">
                    <div className="flex flex-col text-center w-full mb-10">
                        <div className="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Master Cleanse <span className="text-[#aa0000]">Reliac Heirloom</span></div>
                    ...
                    <ScrollTrigger onEnter={() => setCounterOn(true)} onExit={() => setCounterOn(false)}>
                        <div className="flex flex-wrap text-center" style={{ fontFamily: 'Josefin Sans' }}>
                            <div className="md:p-4 md:w-1/4 sm:w-1/2 w-full">
                                <div className="border-2 border-[#aa0000] px-4 py-6 rounded-lg counter-box">
                                    <FiUsers className="text-[#aa0000] w-12 h-12 mb-3 inline-block counter-icon" />
                            ...
                            <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
                                <div className="border-2 border-[#aa0000] px-4 py-6 rounded-lg counter-box">
                                    <IoIosDoneAll className="text-[#aa0000] w-12 h-12 mb-3 inline-block counter-icon" />
                                    <div className="title-font font-medium text-3xl text-gray-900 counter-text">
                            ...
                            <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
                                <div className="border-2 border-[#aa0000] px-4 py-6 rounded-lg counter-box">
                                    <RiCommunityLine className="text-[#aa0000] w-12 h-12 mb-3 inline-block counter-icon" />
                                    <div className="title-font font-medium text-3xl text-gray-900 counter-text">
                            ...
                            <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
                                <div className="border-2 border-[#aa0000] px-4 py-6 rounded-lg counter-box">
                                    <FaPlaceOfWorship className="text-[#aa0000] w-12 h-12 mb-3 inline-block counter-icon" />
                                    <div className="title-font font-medium text-3xl text-gray-900 counter-text">
