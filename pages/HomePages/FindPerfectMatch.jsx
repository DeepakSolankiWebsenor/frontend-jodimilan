    ...
    <div className="flex flex-col md:flex-row items-center gap-10 px-5 py-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            <div className="grid gap-1">
              ...
              <select
                ...
                className="outline-none p-2 bg-white rounded-md text-xs font-medium"
              >
                <option value="" hidden>
                  Please Select
                </option>
            ...
            <div className="grid gap-1 w-full">
              ...
              <div className="flex items-center gap-2 w-full">
                <select
                  ...
                  value={form.minAge}
                  onChange={handleChange}
                  className="outline-none p-2 bg-white rounded-md text-xs font-medium w-full"
                >
                  <option value="" hidden>
                    Please Select
                  </option>
      ...
      <div className="w-full md:w-1/2 flex flex-wrap justify-center gap-4 mt-5 md:mt-0">
        <Image
          ...
          height={400}
          width={600}
          className="object-contain w-[200px] sm:w-[250px] md:w-[300px] rounded-lg"
        />
        <Image
